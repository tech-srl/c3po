...
class TransformerCtx(nn.Module):
    def __init__(self, vocab_size, device, in_dim=512, num_head=8, num_layers=4, dropout=0.25):
        super(TransformerCtx, self).__init__()
        h_dim = 8 * in_dim
    ...
    def forward(self, src):
        ...
        packed_output = pack_padded_sequence(output, src_lengths, enforce_sorted=False)
