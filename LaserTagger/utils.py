            ...
            with open(filename, 'r') as f:
                for line in f:
                    for path in line.split("\t"):
                        tokens = [t.strip() for t in path.split(" ") if t != Constants.DOWN_WORD and t != Constants.UP_WORD]
